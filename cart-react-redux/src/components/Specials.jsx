                ...
                <div style={{ backgroundColor: 'tan' }}>
                    ...
                    <Carousel>
                        <Carousel.Item interval={1000}>
                            <img className="d-block  w-100" src='/src/assets/BreakfastSpecial.png' alt='BreakfastSpecial Image' />
                            <Carousel.Caption>
                        ...
                        <Carousel.Item interval={500}>
                            <img className="d-block w-100" src='/src/assets/LunchSpecial.png' alt='LunchSpecial Image' />
                            <Carousel.Caption>
                                <h3>Lunch Special.</h3>
                        ...
                        <Carousel.Item>
                            <img className="d-block w-100 " src='/src/assets/DinnerSpecial.png' alt='DinnerSpecial Image' />
                            <Carousel.Caption>
